  ...
  let s : State.t =
    {
      ...
      player1 = { pos_x = 10; pos_y = height / 2; width = 8; height = 64 };
      player2 =
        { pos_x = width - 10; pos_y = height / 2; width = 8; height = 64 };
      window_width = width;
